...
entityTypes = ['Wizard', 'Skeleton', 'Rat']
Frames = 2
FrameDict = {}
...
class Entity:
    def __init__(self, x, y, typeOf, caption, scene = None, collisionRect = None, offset = [0,0]):
        self.x, self.y = x, y
        self.speed = 3
        self.scene = scene
        self.type = typeOf
...
class Player(Entity):
    def __init__(self, x, y, Type, Caption, scene = None, collisionRect = None, offset = [0,0]):
        super().__init__(x, y, Type, Caption, scene, collisionRect, offset)
        self.contacts = []
